...
$query = "SELECT * FROM vawc WHERE user_id = (SELECT user_id FROM users WHERE username = '$username')";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" &&
    ...
    $sql = "INSERT INTO vawc (user_id, question1, question2, question3, question4, question5) 
