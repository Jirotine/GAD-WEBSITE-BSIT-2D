        ...
        <div class="col-sm-12 col-lg-6 col-md-6">
            <div class="box">
                <form id="surveyForm" action="../Util/surveyHandler1.php" method="post" onsubmit="return validateForm()">
                    <div class="Question">
                        <p>1. Have you received harassment training?</p>
                    ...
                    <div class="Question">
                        <p>2. Would you report harassment?</p>
                    ...
                    <div class="Question">
                        <p>3. Do you know reporting procedures?</p>
            ...
            <div class="col-sm-12 col-lg-6 col-md-6">
                <div class="box1">
                    <div class="Question">
                        <p>4. Are consequences clear for harassers?</p>
                    ...
                    <div class="Question">
                        <p>5. Are you satisfied with prevention measures?</p>
