        ...
        <div class="col-sm-12 col-lg-6 col-md-6">
            <div class="box">
                <form id="surveyForm" action="../Util/surveyHandler2.php" method="post" onsubmit="return validateForm()">
                    <div class="Question">
                        <p>1. Do you feel safe in your workplace/school/community?</p>
                    ...
                    <div class="Question">
                        <p>2. Have you witnessed or experienced harassment/bullying?</p>
                    ...
                    <div class="Question">
                        <p>3. Are you aware of policies against harassment??</p>
            ...
            <div class="col-sm-12 col-lg-6 col-md-6">
                <div class="box1">
                    <div class="Question">
                        <p>4. Are there support systems for victims?</p>
                    ...
                    <div class="Question">
                        <p>5. Do you find current safety measures effective?</p>
