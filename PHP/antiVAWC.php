        ...
        <div class="col-sm-12 col-lg-6 col-md-6">
            <div class="box">
                <form id="surveyForm" action="../Util/surveyHandler3.php" method="post">
                    <div class="Question">
                        <p>1. Have you witnessed or experienced violence?</p>
                    ...
                    <div class="Question">
                        <p>2. Are support services available for survivors?</p>
                    ...
                    <div class="Question">
                        <p>3. Do you know legal protections?</p>
            ...
            <div class="col-sm-12 col-lg-6 col-md-6">
                <div class="box1">
                    <div class="Question">
                        <p>4. Is there enough awareness about the issue?</p>
                    ...
                    <div class="Question">
                        <p>5. Do survivors receive adequate support and justice?</p>
